...
<ArticleMetaTags 
  ...
  image="https://res.cloudinary.com/dz3c2rl2o/image/upload/v1704142851/media/ActionsChromeExtBanner.jpg"
/>
...
<CldImage src="media/MyOldDesktopScreenshot.png" alt="The current state of my desktop" width="700" height="700" className="p-2 pt-0" />
...
<CldImage src="media/HumaneBrowserMockup.png" alt="Humane browser mockup" width="700" height="700" className="p-2 pt-0" />
...
<CldImage src="media/ActionsChromeExtBanner.jpg" alt="Actions Chrome extension banner" width="700" height="700" className="p-2 pt-0" />
