...
<ArticleMetaTags 
  ...
  image="https://res.cloudinary.com/dz3c2rl2o/image/upload/v1704142858/media/TheWalletOfTomorrow.png"
/>
...
<CldImage src="media/RoamResearchWorkspace.png" alt="A Roam Research workspace containing a page and a block outline" width="700" height="700" className="p-2 pt-0" />
...
<CldImage src="media/BerrypickingSearch.png" alt="A visualization the information seeking process of berrypicking" width="700" height="700" className="p-2 pt-0" />
...
<CldImage src="media/ApolloGraphQLPlayground.png" alt="A screenshot of the GraphQL-Apollo playground" width="700" height="700" className="p-2 pt-0" />
...
<CldImage src="media/MakeSpaceApp.png" alt="An example of social browsing in the MakeSpace desktop app" width="700" height="700" className="p-2 pt-0" />
