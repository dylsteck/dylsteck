...
<ArticleMetaTags 
  ...
  description="Product Launch NFTs"
  slug="product-launch-nfts"
  image="https://res.cloudinary.com/dz3c2rl2o/image/upload/v1704142862/media/ProductLaunchNFTs.png"
/>
...
<CldImage src="media/ChainstoryScreenshot.png" alt="Chainstory screenshot" width="700" height="700" className="p-2 pt-0" />
...
<CldImage src="media/YupScreenshot.png" alt="Yup screenshot" width="700" height="700" className="p-2 pt-0" />
