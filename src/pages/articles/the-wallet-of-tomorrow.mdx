...
<CldImage src="media/CoinbaseMetamaskComparison.png" alt="Coinbase Wallet MetaMask" width="700" height="700" className="p-2 pt-0" />
...
<CldImage src="media/DuneEthWalletsWeekly.png" alt="Dune ETH Wallets Weekly" width="700" height="700" className="p-2 pt-0" />
