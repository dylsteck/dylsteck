...
<ArticleMetaTags 
  ...
  slug="2023-recap"
  image="https://res.cloudinary.com/dz3c2rl2o/image/upload/v1704345283/media/2023-recap-og-image.png"
/>

<MintOnZora url="https://zora.co/collect/base:0x87aecc43bb1dab2b012feccd3aa888154fb1bebe/1" />
...
<CldImage src="media/NextInTechJan282023.png" alt="The first Next in Tech from Jan 28, 2023" width="500" height="500" className="p-2 pt-0 rounded-2xl" />
...
<CldImage src="media/casterscan-v1-website.jpg" alt="Casterscan v1 with Yash Karthik" width="550" height="550" className="p-2 pt-0 rounded-2xl" />
...
<CldImage src="media/farcasterkit-v1-website.jpg" alt="FarcasterKit v1 website" width="550" height="550" className="p-2 pt-0 rounded-2xl" />
...
<CldImage src="media/openai-dev-day-recap-yt-thumbnail.png" alt="OpenAI Dev Day" width="550" height="550" className="p-2 pt-0 rounded-2xl" />
