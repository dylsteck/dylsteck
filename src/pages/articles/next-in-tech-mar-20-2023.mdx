...
<ArticleMetaTags 
  ...
  image="https://res.cloudinary.com/dz3c2rl2o/image/upload/v1704142856/media/NextInTechMar202023.png"
/>
...
<CldImage src="media/OpenAIWireframeDemo.png" alt="OpenAIWireframeDemo" width="700" height="700" className="p-2 pt-0" />
...
<CldImage src="media/Khanmigo.jpg" alt="Khanmigo" width="700" height="700" className="p-2 pt-0" />
