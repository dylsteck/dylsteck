...
<ArticleMetaTags 
  ...
  image="https://res.cloudinary.com/dz3c2rl2o/image/upload/v1704142858/media/TheBoomOfFarcastersDeveloperCommunity.png"
/>
...
<CldImage src="media/FarcasterScreenshot.png" alt="Farcaster Screenshot" width="250" height="250" className="p-2 pt-0" />
...
<CldImage src="media/FCRoadmapQ12023.png" alt="FC Roadmap Q1 2023" width="700" height="700" className="p-2 pt-0" />
...
<CldImage src="media/MessariDeSoMap.jpg" alt="Messari DeSo Market Map" width="700" height="700" className="p-2 pt-0" />
