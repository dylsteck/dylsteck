...
import { appUrl, bannerImg, iconImg } from '../lib/site'
      ...
      GET: async () => {
        const config = {
          accountAssociation: {
            ...
            signature:
              'MHg3ZWQ3OGZiNmE4NDkwYTZiNTUxNWI3NjY2NTlmMTZmMzkzMmUyMmUwYWY0M2Q0NTY3MWM4OGMxMTc1NGFlNTk4MmIwMGQ0ZWRiM2Y0Mjg0NzkxNGYwMTI4ZjE0NDE1YjEzYWM5NGY3MTMwMGJkNzY2MGE3ZTEyZmRjZjNlY2I3OTFj',
          },
          frame: {
            version: '1',
            name: 'Dylan Steck',
            ...
            description:
              'The homepage of Dylan Steck, an engineer at Base building products onchain',
            iconUrl: iconImg,
            ...
            noindex: false,
            webhookUrl:
              'https://api.neynar.com/f/app/485da491-ac40-4352-bf1c-e1ca8013d62a/event',
