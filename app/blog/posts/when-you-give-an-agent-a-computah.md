...
This is where I think there's so much room to innovate in the future, especially making interfaces that help every day people and not just coders. It's also worth noting before going deeper that as the models themselves get better, their new capabilities will unlock features we couldn't have conceived beforehand(or at least that they'd come so quickly). I'm going to break this part into two sections: the next architecture and the next set of interfaces.
