...
export default function Media(){
    ...
    return(
        <div>
            <div className="mt-4 md:mt-12 mb-2 flex flex-row gap-2 items-center text-black dark:text-white">
                <p className={`cursor-pointer hover:opacity-70 ${activeTab === 'all' ? 'font-semibold' : ''}`} onClick={() => handleTabClick('all')}>all</p>
                <p>/</p>
                <p className={`cursor-pointer hover:opacity-70 ${activeTab === 'blog' ? 'font-semibold' : ''}`} onClick={() => handleTabClick('blog')}>blog</p>
                <p>/</p>
                <p className={`cursor-pointer hover:opacity-70 ${activeTab === 'video' ? 'font-semibold' : ''}`} onClick={() => handleTabClick('video')}>video</p>
            </div>
